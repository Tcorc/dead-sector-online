...
{x:12,z:13,type:"pack",label:((p.packLevels?.[p.activeSlot||0]||0)>=3)
  ?"MAX WEAPON UPGRADE"
  :`UPGRADE WEAPON LVL ${(p.packLevels?.[p.activeSlot||0]||0)+1} — ${[0,5000,15000,30000][(p.packLevels?.[p.activeSlot||0]||0)+1]||0}`,
  active:S.doors.lab},
